...
export const ServiceData = [
  {
    ...
    list:"Hello id aute voluptate mollit irure aute tempor irure. Eu labore Lorem cillum ipsum non commodo qui sunt aliquip qui labore nostrud sint ullamco. Deserunt velit labore occaecat laboris.",
  ...
  },
  {
    ...
    buttonName: "View service",
    list:"Aute id aute voluptate mollit irure aute tempor irure. Eu labore Lorem cillum ipsum non commodo qui sunt aliquip qui labore nostrud sint ullamco. Deserunt velit labore occaecat laboris.",
  ...
  return (
    <div className="services container-fluid">
      ...
      <center className="pt-2 my-4">
        <Link className="all-services" href="/services">
          View all Services
        </Link>
      </center>
    </div>
